...
def visualization(DANN_synth_feature, DANN_real_feature, No_DANN_synth_feature, No_DANN_real_feature, DANN_path=None, No_DANN_path=None, sample_num=1000):
    print("start visualization")

    DANN_tsne_path = os.path.join(DANN_path, 'tsne(frame).npy')
    N_DANN_tsne_path = os.path.join(No_DANN_path, 'tsne(frame)_DASSL.npy')
    ...
    plt.ylim(-90, 90)
    plt.axis('off')
    plt.savefig(os.path.join(DANN_path, 'DASSL(frame).png'))# plt.savefig(os.path.join(DANN_path, 'Adaptation(frame).png'))
    ...
    plt.ylim(-90, 90)
    plt.axis('off')
    plt.savefig(os.path.join(No_DANN_path, 'No_DASSL(frame).png'))# plt.savefig(os.path.join(No_DANN_path, 'No_adaptation(frame).png'))
...
def svm_classfication(DANN_synth_feature, DANN_real_feature, No_DANN_synth_feature, No_DANN_real_feature, sample_num=1000):
