...
def visualization(ADA_synth_feature, ADA_real_feature, No_ADA_synth_feature, No_ADA_real_feature, ADA_path=None, No_ADA_path=None, sample_num=None):
    print("start visualization")

    ADA_tsne_path = os.path.join(ADA_path, 'tsne(clip).npy')
    No_ADA_tsne_path = os.path.join(No_ADA_path, 'tsne(clip).npy')
    ...
    if not os.path.exists(ADA_tsne_path):
        if sample_num != None:
            ...
            ADA_feature = np.concatenate((ADA_synth_feature, ADA_real_feature), axis=0)
    ...
    if not os.path.exists(No_ADA_tsne_path):
        if sample_num != None:
            ...
            No_ADA_feature = np.concatenate((No_ADA_synth_feature, No_ADA_real_feature), axis=0)
    ...
    if sample_num != None:
        ...
        ADA_synth_feature_sample = ADA_feature[:ADA_synth_feature.shape[0]]
        ADA_real_feature_sample = ADA_feature[ADA_synth_feature.shape[0]:]
        No_ADA_synth_feature_sample = No_ADA_feature[:ADA_synth_feature.shape[0]]
        No_ADA_real_feature_sample = No_ADA_feature[ADA_synth_feature.shape[0]:]
    ...
    plt.ylim(-90, 90)
    plt.axis('off')
    plt.savefig(os.path.join(ADA_path, 'Adaptation(clip).png'))
    ...
    plt.ylim(-90, 90)
    plt.axis('off')
    plt.savefig(os.path.join(No_ADA_path, 'No_adaptation(clip).png'))


def svm_classfication(ADA_synth_feature, ADA_real_feature, No_ADA_synth_feature, No_ADA_real_feature, sample_num=None):
    ...
    if sample_num != None:
        ...
        No_ADA_synth_feature_sample = No_ADA_synth_feature
        No_ADA_real_feature_sample = No_ADA_real_feature
    No_ADA_feature = np.concatenate((No_ADA_synth_feature_sample, No_ADA_real_feature_sample), axis=0)
